...
describe('timed out attempts', () => {
  ...
  const claimTimeout = async () =>
    await test.creatorClaimTimeout({
      ...
      expectedRefund: 3.73298, // initial prize + (1 - service fee)
      expectedRefundApproximation: 3,
      expectedServiceShare: 0.683246, // service fee
      expectedServiceShareApproximation: 1,
      expectedGameTotalPuzzlesTimedOut: 1,
      expectedGameTotalPuzzlesTimedOutValue: 3.732982,
      expectedPlayerTotalPuzzlesTimedOut: 1,
      expectedPlayerTotalPuzzlesTimedOutValue: 3.732982,
    });
  ...
  beforeAll(async () => {
    ...
    await test.faucetToken(test.usdcMint, test.creator1UsdcTokenAccount, 2);
    await test.faucetToken(test.usdcMint, test.solver1UsdcTokenAccount, 10);
    ...
    attempt1 = {
      ...
      expectedPuzzleNextFee: 0.316227,
    };
    ...
    attempt2 = {
      ...
      expectedFee: 0.316227,
      expectedGameTotalAttemptsMade: 2,
      expectedGameTotalFeesPaid: 0.416227,
      expectedPuzzleTotalAttemptsMade: 2,
      expectedPuzzleTotalFeesPaid: 0.416227,
      expectedWalletTotalAttemptsMade: 2,
      expectedWalletTotalFeesPaid: 0.416227,
    ...
    attempt3 = {
      ...
      expectedGameTotalFeesPaid: 1.416227,
      expectedPuzzleTotalAttemptsMade: 3,
      expectedPuzzleTotalFeesPaid: 1.416227,
      expectedWalletTotalAttemptsMade: 3,
      expectedWalletTotalFeesPaid: 1.416227,
      expectedPuzzleNextFee: 1,
    };
    ...
    attempt4 = {
      ...
      expectedGameTotalFeesPaid: 2.416227,
      expectedPuzzleTotalAttemptsMade: 4,
      expectedPuzzleTotalFeesPaid: 2.416227,
      expectedWalletTotalAttemptsMade: 4,
      expectedWalletTotalFeesPaid: 2.416227,
      expectedPuzzleNextFee: 1,
    };
    ...
    attempt5 = {
      ...
      expectedGameTotalFeesPaid: 3.416227,
      expectedPuzzleTotalAttemptsMade: 5,
      expectedPuzzleTotalFeesPaid: 3.416227,
      expectedWalletTotalAttemptsMade: 5,
      expectedWalletTotalFeesPaid: 3.416227,
      expectedPuzzleNextFee: 1,
    };
